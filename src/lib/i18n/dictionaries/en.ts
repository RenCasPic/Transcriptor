...
export const en: Dictionary = {
  ...
  dashboard: {
    ...
    addContentTitle: 'Add your content',
    addContentHint: 'Choose how to provide your video content.',
    sourceUploadTab: 'Upload video',
    sourceUrlTab: 'Paste link',
    customizeTitle: 'Customize your article',
    dropzonePrompt: 'Drag your video or audio here, or click to choose it',
  ...
  editor: {
    ...
    outline: {
      ...
      empty: 'Add headings (H2, H3) to see the article outline.',
    },
    preview: {
      label: 'Preview',
      enter: 'Preview',
    ...
    seoPanel: {
      ...
      checkedLabel: 'checks',
      googlePreviewLabel: 'Google preview',
      metaDescriptionEmpty: 'Add a meta description to control how the article looks in search results.',
